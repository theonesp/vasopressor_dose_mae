...
## Outside and inside CPB

```{r}
# AUC vars
FinalHemodynamicsDataset['Q_AUC65MAP_CPB_mmHgmin']<-as.numeric(cut2(FinalHemodynamicsDataset$AUC65MAP_CPB_mmHgmin, g=4))
FinalHemodynamicsDataset['Q_AUC65MAP_outsideCPB_mmHgmin']<-as.numeric(cut2(FinalHemodynamicsDataset$AUC65MAP_outsideCPB_mmHgmin, g=4))
FinalHemodynamicsDataset['Q_AUC65MAP_preCPB_mmHgmin']<-as.numeric(cut2(FinalHemodynamicsDataset$AUC65MAP_preCPB_mmHgmin, g=4))
FinalHemodynamicsDataset['Q_AUC65MAP_postCPB_mmHgmin']<-as.numeric(cut2(FinalHemodynamicsDataset$AUC65MAP_postCPB_mmHgmin, g=4))

# TWA vars
FinalHemodynamicsDataset['Q_TWA65MAP_CPB_mmHg']<-as.numeric(cut2(FinalHemodynamicsDataset$TWA65MAP_CPB_mmHg, g=4))
FinalHemodynamicsDataset['Q_TWA65MAP_outsideCPB_mmHg']<-as.numeric(cut2(FinalHemodynamicsDataset$TWA65MAP_outsideCPB_mmHg, g=4))
FinalHemodynamicsDataset['Q_TWA65MAP_preCPB_mmHg']<-as.numeric(cut2(FinalHemodynamicsDataset$TWA65MAP_preCPB_mmHg, g=4))
FinalHemodynamicsDataset['Q_TWA65MAP_postCPB_mmHg']<-as.numeric(cut2(FinalHemodynamicsDataset$TWA65MAP_postCPB_mmHg, g=4))

```

## AUT65MAP_CPB_IOH_ratio

```{r}
FinalHemodynamicsDataset['Q_AUT65MAP_CPB_IOH_ratio']<-as.numeric(cut2(FinalHemodynamicsDataset$AUT65MAP_CPB_IOH_ratio, g=4))
```
...
FinalHemodynamicsDataset['T_STS_RiskAlgorithm_multiple_imp']<-as.factor(as.numeric(cut2(FinalHemodynamicsDataset$STS_RiskAlgorithm_multiple_imp, g=3)))
```
...
FinalHemodynamicsDataset %>% 
  dplyr::group_by(Q_AUT65MAP_total_min)%>%
  dplyr::summarize(min = round(min(AUT65MAP_total_min), 2),
            max = round(max(AUT65MAP_total_min), 2)
            )
```
...
FinalHemodynamicsDataset$Category<-gsub(" ", "", FinalHemodynamicsDataset$Category, fixed = TRUE)

# 2 Format it all in title case
FinalHemodynamicsDataset$Category<-titleCase(FinalHemodynamicsDataset$Category)

# CAB is always in Capital
FinalHemodynamicsDataset$Category<-gsub("Cab", "CAB", FinalHemodynamicsDataset$Category, fixed = TRUE)

# CABG is always in Capital
FinalHemodynamicsDataset$Category<-gsub("CABg", "CABG", FinalHemodynamicsDataset$Category, fixed = TRUE)

# before exclusion
table(FinalHemodynamicsDataset$Category)

FinalHemodynamicsDataset<-FinalHemodynamicsDataset%>%filter(Category!='Other')

FinalHemodynamicsDataset<-FinalHemodynamicsDataset%>%filter(PreOpMedInotropes!=1) #N=44


# after exclusion
table(FinalHemodynamicsDataset$Category)
table(FinalHemodynamicsDataset$PreOpMedInotropes)
```
...
FinalHemodynamicsDataset$Category[ FinalHemodynamicsDataset$Category%in% c('CAB','CABG') ]<-'CAB+other'

FinalHemodynamicsDataset$Category[FinalHemodynamicsDataset$Category=='CAB+valve']<-'CAB+valve+other'

FinalHemodynamicsDataset$Category[FinalHemodynamicsDataset$Category=='Valve']<-'Valve+other'
...
```{r}
saveRDS(FinalHemodynamicsDataset,'FinalHemodynamicsDataset.rds')
```
